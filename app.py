...
# 👇 IMPORT DO ANTIFRAUDE
from antifraude import calcular_score, ip_bloqueado
...
# =========================
# CRIAR / AVALIAR PEDIDO (🔥 ANTIFRAUDE AQUI)
# =========================
@app.route("/avaliar-pedido", methods=["POST"])
def avaliar_pedido():
    ...
    cur.execute("""
        INSERT INTO pedidos (ip, valor, score_risco, motivo, status)
        VALUES (%s, %s, %s, %s, %s)
    """, (
        ip,
        valor,
